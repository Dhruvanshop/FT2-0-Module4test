...
/**
 * Contains the StudentSignupForm class.
 */
...
class StudentSignupForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $student_message = 'Dear ' . $values['full_name'] . ', your student ID is ' . $student_id . '. Your registration details are as follows: Email: ' . $values['email'] . ', Stream: ' . $values['stream'] . ', Joining Year: ' . $values['joining_year'] . ', Passing Year: ' . $values['passing_year'] . '.';
    ...
    $admin_message = 'New student registered with details: Full Name: ' . $values['full_name'] . ', Email: ' . $values['email'] . ', Mobile Number: ' . ', Stream: ' . $values['stream'] . ', Joining Year: ' . $values['joining_year'] . ', Passing Year: ' . $values['passing_year'] . '.';

    $admin_email = 'dhruv040403@gmail.com';
